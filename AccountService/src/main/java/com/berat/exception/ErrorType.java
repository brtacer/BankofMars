...
public enum ErrorType {
    ...
    TRANSFER_FAILED(1301,"Failed to money transfer!",BAD_REQUEST),
    CURRENCIES_NOT_MATCH(1302,"Currencies not match!",BAD_REQUEST),
    INSUFFICIENT_BALANCE(1303,"Transaction not created. Insufficient balance!",BAD_REQUEST),
